...
- `get_lyrics` to create a `.txt` file containing the lyrics of the media that MPD is currently playing at `/tmp`. This is needed for Ncmpcpp to correctly display lyrics
